...
# Analysis parameters
TOP_N_FEATS = 40
NUM_ITER_CLR = 100  # Modify this to reduce the number of iterations!
NUM_ITER_REG = 100  # Modify this to reduce the number of iterations!
...
def main():
    ...
    for col in variables_to_analyze:  # Modify this to run a subset of the variables!
        ...
        if col == "age_group_2":
            col = "age"
        elif col not in ["language", "urbanity", "swiss_citizen"]:
    ...
    featImp_top_all_mb.to_csv("./results/clr_featImp.csv")
